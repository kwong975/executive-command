...
import { GroupHeader, StatusDot, StatusPill, InlineAction, DenseRow, TabBar, PanelHeader, EmptyState } from "@/components/shared";
...
import {
  ...
  Check, Play, ExternalLink, Plus, FileText,
  Users, Mail, Calendar, Cog, Loader2
} from "lucide-react";
    ...
    <DenseRow selected={selected} onClick={onClick}>
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        ...
        <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-all">
          ...
          <button onClick={e => { e.stopPropagation(); onChat(); }} className="p-1 rounded-md hover:bg-accent/20"><Play className="h-3 w-3 text-muted-foreground" /></button>
        </div>
      </div>
    </DenseRow>
  );
  ...
  return (
    <DenseRow>
      ...
      <div className="flex items-center gap-1 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <button onClick={onDismiss} className="p-1 rounded-md hover:bg-destructive/15 text-muted-foreground hover:text-destructive transition-colors">
          <X className="h-3 w-3" />
        </button>
      </div>
    </DenseRow>
        ...
        <div className="flex items-center gap-4 text-xs text-muted-foreground">
          ...
          {matter.people.length > 0 && (
            <span className="flex items-center gap-1">
              ...
              {matter.people.length > 3 && <span>+{matter.people.length - 3}</span>}
            </span>
          )}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button className="p-1 rounded-md hover:bg-secondary"><X className="h-3 w-3 text-muted-foreground" /></button>
                    </div>
                  </div>
                </div>
