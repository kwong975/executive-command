...
export const fakeMatters = {
  matters: [
    { id: "m-perf", canonical_title: "Performance & Incentive System 2026", status: "active", health_state: "blocked", routing_owner: "unassigned", priority: 5, severity: 3, attention_score: 0.9, overdue_commitments: 16, open_commitments: 42, total_commitments: 42, last_activity_at: "2026-03-29", goal_id: "si-s1" },
    { id: "m-hrms", canonical_title: "HRMS Transformation", status: "active", health_state: "blocked", routing_owner: "unassigned", priority: 4, severity: 3, attention_score: 0.85, overdue_commitments: 7, open_commitments: 15, total_commitments: 15, last_activity_at: "2026-03-28", goal_id: "dto-s1" },
    { id: "m-comp", canonical_title: "Compliance & Regulatory Framework", status: "active", health_state: "blocked", routing_owner: "unassigned", priority: 3, severity: 2, attention_score: 0.7, overdue_commitments: 5, open_commitments: 7, total_commitments: 7, last_activity_at: "2026-03-27", goal_id: "lgc-s1" },
    { id: "m-kpi", canonical_title: "VNG 2026 KPI", status: "active", health_state: "blocked", routing_owner: "unassigned", priority: 3, severity: 2, attention_score: 0.65, overdue_commitments: 1, open_commitments: 1, total_commitments: 1, last_activity_at: "2026-03-25", goal_id: "si-s1" },
    { id: "m-erm", canonical_title: "ERM Risk Management Framework", status: "active", health_state: "blocked", routing_owner: "unassigned", priority: 3, severity: 2, attention_score: 0.6, overdue_commitments: 5, open_commitments: 18, total_commitments: 18, last_activity_at: "2026-03-26", goal_id: "lgc-s1" },
    { id: "m-vngg-pub", canonical_title: "VNGG Publishing Growth", status: "active", health_state: "blocked", routing_owner: "chrisliu", priority: 3, severity: 2, attention_score: 0.55, overdue_commitments: 5, open_commitments: 10, total_commitments: 10, last_activity_at: "2026-03-29" },
    { id: "m-dto", canonical_title: "DTO Department Review", status: "active", health_state: "overloaded", routing_owner: "kellytran", priority: 2, severity: 1, attention_score: 0.4, overdue_commitments: 0, open_commitments: 8, total_commitments: 8, last_activity_at: "2026-03-28", goal_id: "dto-s2" },
    { id: "m-vngg-strat", canonical_title: "VNGG Growth & Publishing Strategy", status: "active", health_state: "overloaded", routing_owner: "chrisliu", priority: 2, severity: 1, attention_score: 0.35, overdue_commitments: 11, open_commitments: 22, total_commitments: 22, last_activity_at: "2026-03-29" },
    { id: "m-exec", canonical_title: "VNG Group Strategic Execution 2026", status: "active", health_state: "healthy", routing_owner: "kelly", priority: 2, severity: 1, attention_score: 0.3, overdue_commitments: 2, open_commitments: 5, total_commitments: 5, last_activity_at: "2026-03-20", goal_id: "cp-o1-2026" },
    { id: "m-zp", canonical_title: "ZaloPay Growth & Development", status: "active", health_state: "healthy", routing_owner: "kelly", priority: 2, severity: 1, attention_score: 0.2, overdue_commitments: 0, open_commitments: 3, total_commitments: 3, last_activity_at: "2026-03-25" },
  ],
  count: 10,
};
